...
public class CreateContainerTest extends ClientBase {
    ...
    public void testCreateWithNullStat()
        ...
        zk.create(name, name.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.CONTAINER);
    ...
    public void testSimpleDeletion()
        ...
        ContainerManager containerManager = new ContainerManager(serverFactory.zkServer.getZKDatabase(),
                serverFactory.zkServer.firstProcessor, 1, 100);
    ...
    public void testMultiWithContainerSimple()
        ...
        DataTree dataTree = serverFactory.zkServer.getZKDatabase().getDataTree();
    ...
    public void testMaxPerMinute()
        ...
        final ContainerManager containerManager = new ContainerManager(serverFactory.zkServer.getZKDatabase(), processor, 1, 2) {
            @Override
    ...
    private Stat createWithStatVerifyResult(String newName)
        ...
        Assert.assertNull("Node existed before created", zk.exists(newName, false));
        zk.create(newName, newName.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.CONTAINER);
        Stat stat = zk.exists(newName, false);
